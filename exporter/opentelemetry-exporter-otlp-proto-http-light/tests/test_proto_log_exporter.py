...
from opentelemetry.exporter.otlp.proto.http_light._log_exporter import (
...
class TestOTLPHTTPLogExporter(unittest.TestCase):
    ...
    def export_log_and_deserialize(log):
        with patch.object(_OTLPHTTPClient, "post") as mock_post:
