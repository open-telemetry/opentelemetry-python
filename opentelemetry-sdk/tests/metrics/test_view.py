    ...
    def test_meter_version(self):
        ...
        self.assertTrue(
            View(meter_version="meter_version")._match(
                Mock(**{"_meter.version": "meter_version"})
            )
        )
    ...
    def test_meter_schema_url(self):
        ...
        self.assertTrue(
            View(meter_schema_url="meter_schema_url")._match(
                Mock(**{"_meter.schema_url": "meter_schema_url"})
            )
        )
    ...
    def test_additive_criteria(self):
        ...
        self.assertTrue(
            view._match(
                Mock(
                    **{
                        "_meter.name": "meter_name",
                        "_meter.version": "meter_version",
                        "_meter.schema_url": "meter_schema_url",
                    }
                )
            )
        )
            ...
            view._match(
                Mock(
                    **{
                        "_meter.name": "meter_name",
                        "_meter.version": "meter_version",
                        "_meter.schema_url": "meter_schema_vrl",
                    }
                )
            )
        )
