...
from opentelemetry.sdk._logs import LogEmitter, OTelHandler
...
def get_logger(level=logging.NOTSET, log_emitter=None):
    ...
    handler = OTelHandler(level=level, log_emitter=log_emitter)
    logger.addHandler(handler)
    return logger


class TestOTelHandler(unittest.TestCase):
