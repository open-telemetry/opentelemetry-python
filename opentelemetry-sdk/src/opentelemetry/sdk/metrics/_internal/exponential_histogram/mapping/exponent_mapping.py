...
class ExponentMapping(Mapping):
    ...
    def _init(self, scale: int) -> None:
        ...
        index = MIN_NORMAL_EXPONENT >> -self._scale  # type: ignore
        ...
        self._min_normal_lower_boundary_index = index  # type: ignore
        ...
        self._max_normal_lower_boundary_index = (
            MAX_NORMAL_EXPONENT >> -self._scale  # type: ignore
        )

    def map_to_index(self, value: float) -> int:
        if value < MIN_NORMAL_VALUE:
            return self._min_normal_lower_boundary_index  # type: ignore
