...
class LogarithmMapping(Mapping):
    ...
    def _init(self, scale: int):  # type: ignore[no-untyped-def] # <will add tracking issue num>
        ...
        self._min_normal_lower_boundary_index = (
            MIN_NORMAL_EXPONENT << self._scale  # type: ignore[misc] # <will add tracking issue num>
        )
        ...
        self._max_normal_lower_boundary_index = (  # type: ignore[misc] # <will add tracking issue num>
            (MAX_NORMAL_EXPONENT + 1) << self._scale  # type: ignore[misc] # <will add tracking issue num>
        ) - 1
    ...
    def map_to_index(self, value: float) -> int:
        ...
        if value <= MIN_NORMAL_VALUE:
            return self._min_normal_lower_boundary_index - 1  # type: ignore[misc, no-any-return] # <will add tracking issue num>
        ...
        return min(  # type: ignore[misc, no-any-return] # <will add tracking issue num>
    ...
    def get_lower_boundary(self, index: int) -> float:
        ...
        if index <= self._min_normal_lower_boundary_index:  # type: ignore[misc] # <will add tracking issue num>
            ...
            if index == self._min_normal_lower_boundary_index - 1:  # type: ignore[misc] # <will add tracking issue num>
                return (
