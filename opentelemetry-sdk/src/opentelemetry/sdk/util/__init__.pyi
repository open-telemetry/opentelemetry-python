...
class BoundedList(Sequence[_T]):
    ...
    def append(self, item: _T): ...  # type: ignore[no-untyped-def] # <will add tracking issue num>
    def extend(self, seq: Sequence[_T]): ...  # type: ignore[no-untyped-def] # <will add tracking issue num>
    @classmethod
