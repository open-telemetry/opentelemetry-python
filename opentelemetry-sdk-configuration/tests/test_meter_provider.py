...
from opentelemetry.sdk.configuration._meter_provider import (
...
class TestCreateMeterProviderBasic(unittest.TestCase):
    ...
    def test_configure_with_config_sets_global(self):
        ...
        with patch(
            "opentelemetry.sdk.configuration._meter_provider.metrics.set_meter_provider"
        ) as mock_set:
    ...
    def test_pull_producers_warns(self):
        ...
        with patch.dict(
            ...
            with self.assertLogs(
                "opentelemetry.sdk.configuration._meter_provider",
                level="WARNING",
            ) as cm:
                create_meter_provider(config)
...
class TestCreateViews(unittest.TestCase):
    ...
    def test_stream_attribute_keys_excluded_logs_warning(self):
        ...
        with self.assertLogs(
            "opentelemetry.sdk.configuration._meter_provider", level="WARNING"
        ) as log:
            create_meter_provider(config)
