...
class TestConfigureSdk(unittest.TestCase):
    @patch("opentelemetry.sdk.configuration._sdk.configure_propagator")
    @patch("opentelemetry.sdk.configuration._sdk.configure_logger_provider")
    @patch("opentelemetry.sdk.configuration._sdk.configure_meter_provider")
    @patch("opentelemetry.sdk.configuration._sdk.configure_tracer_provider")
    @patch("opentelemetry.sdk.configuration._sdk.create_resource")
