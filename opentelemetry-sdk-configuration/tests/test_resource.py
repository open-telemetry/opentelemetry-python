...
from opentelemetry.sdk.configuration._resource import create_resource
...
from opentelemetry.sdk.configuration.models import Resource as ResourceConfig
...
class TestCreateResourceAttributesList(unittest.TestCase):
    ...
    def test_attributes_list_invalid_pair_skipped(self):
        with self.assertLogs(
            "opentelemetry.sdk.configuration._resource", level="WARNING"
        ) as cm:
