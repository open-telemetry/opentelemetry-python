...
(
 ...
 for d in opentelemetry-api/ opentelemetry-sdk/ opentelemetry-auto-instrumentation/ opentelemetry-instrumentation/ opentelemetry-proto/ exporter/*/ instrumentation/*/ ; do
   (
     echo "building $d"
     cd "$d"
