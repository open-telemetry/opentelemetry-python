...
- `opentelemetry-exporter-otlp-proto-grpc`: Log grpc error details when grpc request fails ([#5143](https://github.com/open-telemetry/opentelemetry-python/pull/5143)).
