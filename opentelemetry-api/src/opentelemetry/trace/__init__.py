...
from opentelemetry.attributes import _create_immutable_attributes # type: ignore
...
class Link(_LinkBase):
    ...
    def __init__(
        ...
        self._attributes = _create_immutable_attributes(attributes) # type: types.Attributes
