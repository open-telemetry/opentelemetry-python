...
class MetricOptions:
	def __init__(self,
				 ...
				 contstant_labels: typing.Dict[LabelKey, LabelValue],
				 component: str,
		...
		Args:
			...
			label_values: A map of constant labels that will be used for
...
class MeasureOptions:
	def __init__(self,
				 description: str,
				 unit: str,
				 measure_type: MeasureType = MeasureType.DOUBLE) -> MeasureOptions:
...
class CounterDouble(Metric):
	...
	def get_default_time_series(self) -> TimeSeries:
