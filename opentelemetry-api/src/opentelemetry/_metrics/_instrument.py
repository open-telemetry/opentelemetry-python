...
class _Synchronous(Instrument):
    pass


class _Asynchronous(Instrument):
    @abstractmethod
    def __init__(
        self,
        name,
...
class Counter(_Monotonic, _Synchronous):
...
class UpDownCounter(_NonMonotonic, _Synchronous):
...
class ObservableCounter(_Monotonic, _Asynchronous):
...
class ObservableUpDownCounter(_NonMonotonic, _Asynchronous):
...
class Histogram(_Grouping, _Synchronous):
...
class ObservableGauge(_Grouping, _Asynchronous):
