...
#   timestamp: 2026-07-21T12:46:47+00:00
...
ExperimentalAlwaysContinueTraceContinuationDecider: TypeAlias = (
    dict[str, Any] | None
)


ExperimentalAlwaysRestartWithLinkTraceContinuationDecider: TypeAlias = (
    dict[str, Any] | None
)


ExperimentalAlwaysRestartWithoutLinkTraceContinuationDecider: TypeAlias = (
    dict[str, Any] | None
)
...
@dataclass
class ExperimentalRuleBasedTraceContinuationDeciderAttributePatterns:
    key: str
    included: list[str] | None = None
    excluded: list[str] | None = None
...
@dataclass
class ExperimentalRuleBasedTraceContinuationDeciderAttributeValues:
    key: str
    values: list[str]


@dataclass
class ExperimentalRuleBasedTraceContinuationDeciderConditions:
    """
    Match conditions for an ExperimentalRuleBasedTraceContinuationDeciderRule. When multiple conditions are specified, all must match.
    """

    attribute_values: (
        list[ExperimentalRuleBasedTraceContinuationDeciderAttributeValues]
        | None
    ) = None
    attribute_patterns: (
        list[ExperimentalRuleBasedTraceContinuationDeciderAttributePatterns]
        | None
    ) = None
...
class ExperimentalTraceContinuationDirection(Enum):
    ingress = "ingress"
    egress = "egress"


class ExperimentalTraceContinuationEgressAction(Enum):
    inject_trace_context = "inject_trace_context"
    suppress_trace_context = "suppress_trace_context"


class ExperimentalTraceContinuationStrategy(Enum):
    continue_ = "continue"
    restart_with_link = "restart_with_link"
    restart_without_link = "restart_without_link"
...
@dataclass
class ExperimentalRuleBasedTraceContinuationDeciderRule:
    """
    A rule for ExperimentalRuleBasedTraceContinuationDecider. Rules are matched in order, and the first matching rule determines the trace continuation result.

    """

    direction: ExperimentalTraceContinuationDirection
    span_kind: SpanKind | None = None
    conditions: (
        ExperimentalRuleBasedTraceContinuationDeciderConditions | None
    ) = None
    strategy: ExperimentalTraceContinuationStrategy | None = None
    egress_action: ExperimentalTraceContinuationEgressAction | None = None
    link_attributes: list[AttributeNameValue] | None = None
...
@dataclass
class IdGenerator:
    random: RandomIdGenerator | None = None
    additional_properties: ClassVar[dict[str, Any]]
...
@dataclass
class ExperimentalRuleBasedTraceContinuationDecider:
    rules: list[ExperimentalRuleBasedTraceContinuationDeciderRule]
    default_ingress_strategy: ExperimentalTraceContinuationStrategy | None = (
        None
    )
    default_egress_action: ExperimentalTraceContinuationEgressAction | None = (
        None
    )
...
@_additional_properties
@dataclass
class ExperimentalTraceContinuationDecider:
    always_continue_development: (
        ExperimentalAlwaysContinueTraceContinuationDecider | None
    ) = None
    always_restart_with_link_development: (
        ExperimentalAlwaysRestartWithLinkTraceContinuationDecider | None
    ) = None
    always_restart_without_link_development: (
        ExperimentalAlwaysRestartWithoutLinkTraceContinuationDecider | None
    ) = None
    rule_based_development: (
        ExperimentalRuleBasedTraceContinuationDecider | None
    ) = None
    additional_properties: ClassVar[dict[str, Any]]
...
class PeriodicMetricReader:
    ...
    timeout: int | None = None
    max_export_batch_size_development: int | None = None
    producers: list[MetricProducer] | None = None
    cardinality_limits: CardinalityLimits | None = None
...
class TracerProvider:
    ...
    trace_continuation_decider_development: (
        ExperimentalTraceContinuationDecider | None
    ) = None
