...
nitpick_ignore = [
    ...
    ("py:class", "PathLike"),
    # ``Compression``/``BaseHTTPTransport`` resolve to their private defining
    # modules in the json-http exporter's type hints; those modules aren't
    # documented on their own.
