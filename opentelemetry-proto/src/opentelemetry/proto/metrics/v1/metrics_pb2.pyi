...
class _AggregationTemporalityEnumTypeWrapper(
    ...
    AGGREGATION_TEMPORALITY_UNSPECIFIED: AggregationTemporality.ValueType = (
        ...
    )  # 0
    ...
    AGGREGATION_TEMPORALITY_CUMULATIVE: AggregationTemporality.ValueType = (
        ...
    )  # 2
...
class _DataPointFlagsEnumTypeWrapper(
    ...
    DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK: DataPointFlags.ValueType = (
        ...
    )  # 1
...
class DataPointFlags(
    _DataPointFlags, metaclass=_DataPointFlagsEnumTypeWrapper
):
    ...
    def __init__(
        ...
        *,
        resource_metrics: typing.Optional[
            typing.Iterable[global___ResourceMetrics]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class ResourceMetrics(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        scope_metrics: typing.Optional[
            typing.Iterable[global___ScopeMetrics]
        ] = ...,
        schema_url: typing.Text = ...,
    ) -> None: ...
    def HasField(
...
class Metric(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        exponential_histogram: typing.Optional[
            global___ExponentialHistogram
        ] = ...,
    ...
    def __init__(
        ...
        *,
        data_points: typing.Optional[
            typing.Iterable[global___NumberDataPoint]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class Histogram(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        data_points: typing.Optional[
            typing.Iterable[global___HistogramDataPoint]
        ] = ...,
        aggregation_temporality: global___AggregationTemporality.ValueType = ...,
    ) -> None: ...
    def ClearField(
...
class ExponentialHistogram(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        data_points: typing.Optional[
            typing.Iterable[global___ExponentialHistogramDataPoint]
        ] = ...,
        aggregation_temporality: global___AggregationTemporality.ValueType = ...,
    ) -> None: ...
    def ClearField(
...
class Summary(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        data_points: typing.Optional[
            typing.Iterable[global___SummaryDataPoint]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class HistogramDataPoint(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        time_unix_nano: builtins.int = ...,
        count: builtins.int = ...,
        sum: typing.Optional[builtins.float] = ...,
        bucket_counts: typing.Optional[typing.Iterable[builtins.int]] = ...,
        explicit_bounds: typing.Optional[
...
class ExponentialHistogramDataPoint(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        scale: builtins.int = ...,
        zero_count: builtins.int = ...,
        positive: typing.Optional[
            global___ExponentialHistogramDataPoint.Buckets
        ] = ...,
        negative: typing.Optional[
            global___ExponentialHistogramDataPoint.Buckets
        ] = ...,
        flags: builtins.int = ...,
        exemplars: typing.Optional[typing.Iterable[global___Exemplar]] = ...,
